              ...
              <div class="box box-solid">
                  ...
                  <div class="nav-tabs-custom">
                      <ul class="nav nav-tabs">
                          <li @if($parameters['type'] == 0)class="active" @endif><a href="#1" data-toggle="tab">新订单</a></li>
                          <li @if($parameters['type'] == 1)class="active" @endif><a href="#2" data-toggle="tab">已支付订单</a></li>

                          <li @if($parameters['type'] == 2)class="active" @endif><a href="#3" data-toggle="tab">过期订单</a></li>
                      </ul>
                      <div class="tab-content">
                          <div class="@if($parameters['type'] == 0)active @endif tab-pane" id="1">
                              <div class="nav-tabs-custom">
                                  <div class="tab-content">
                          ...
                          <div class="@if($parameters['type'] == 1)active @endif tab-pane" id="2">
                              <div class="nav-tabs-custom">
                                  <div class="tab-content">
                                      <div class="active tab-pane" id="timeline">
                                          <!-- /.box-header -->
